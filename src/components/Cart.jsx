            ...
            <div className="cart-items">
              {cart.cartItems?.map((cartItem) => (
                <div className="cart-item" key={cartItem.id}>
                  ...
                  <div className="cart-porduct-price">${cartItem.price}</div>

                  <div className="cart-product-qantity-web">
                    <div className="cart-product-qantity">
                  ...
                  <div className="cart-product-qantity-mobile">
                    <div className="cart-product-qantity">
                      <button onClick={() => handleIncreaseCart(cartItem)}>
                        +
                      </button>
